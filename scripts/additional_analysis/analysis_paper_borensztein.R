...
table_NSMB_paper = read.table(file = here('data/annotation_files/silencing_classes','silencing_classes_borensztein.txt'),sep='\t',header = F)
...
cairo_pdf(here("plots/additional_analysis","analysis_paper_borensztein.pdf"),width = 2,height = 2.3, onefile = TRUE)
