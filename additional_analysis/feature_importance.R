...
load("/project/lncrna/Xist/data/modelling/model/silencing_dynamics_model/results_thr_0.5_0.9_1.3/random_forest_model_all_features.RData")
...
pdf(file = "/project/lncrna/Xist/plots/additional_analysis/feature_importance.pdf",height = 20, width = 10)
