...
output_dir = '/project/lncrna/Xist/plots/silencing_halftimes/'
file_pro_seq_raw = '/project/lncrna/Xist/data/silencing_halftimes/raw_data/PROseq.txt'
file_pro_seq_all = "/project/lncrna/Xist/data/silencing_halftimes/fitted_data/halftimes_pro_seq_mm10_RSS_initial_ratio.txt"
file_pro_seq_halftimes = '/project/lncrna/Xist/data/silencing_halftimes/fitted_data/halftimes_pro_seq_mm10.bed'
file_mrna_seq_undiff_raw = '/project/lncrna/Xist/data/silencing_halftimes/raw_data/UndifferenciatedCells.txt'
file_mrna_seq_undiff_all = "/project/lncrna/Xist/data/silencing_halftimes/fitted_data/halftimes_mrna_seq_undiff_mm10_RSS_initial_ratio.txt"
file_mrna_seq_undiff_halftimes = '/project/lncrna/Xist/data/silencing_halftimes/fitted_data/halftimes_mrna_seq_undiff_mm10.bed'
file_mrna_seq_diff_raw = '/project/lncrna/Xist/data/silencing_halftimes/raw_data/DifferenciatedCells.txt'
file_mrna_seq_diff_all = "/project/lncrna/Xist/data/silencing_halftimes/fitted_data/halftimes_mrna_seq_diff_mm10_RSS_initial_ratio.txt"
file_mrna_seq_diff_halftimes = '/project/lncrna/Xist/data/silencing_halftimes/fitted_data/halftimes_mrna_seq_diff_mm10.bed'
file_gencode_gene_annotation = "/project/lncrna/Xist/data/annotation_files/gene_annotation/gencode.vM9.annotation.chrX.genes.bed"
...
#fit the data
CairoPDF(paste(output_dir,'pro_seq_fit.pdf',sep=''),width = 7,height = 7)
...
CairoPDF(paste(output_dir,'pro_seq_ratios.pdf',sep=''),width = 10,height = 20)
...
#fit the data
CairoPDF(paste(output_dir,'mrna_seq_undiff_fit.pdf',sep=''),width = 7,height = 7)
...
CairoPDF(paste(output_dir,'mrna_seq_undiff_ratios.pdf',sep=''),width = 10,height = 20)
...
#fit the data
CairoPDF(paste(output_dir,'mrna_seq_diff_fit.pdf',sep=''),width = 7,height = 7)
...
CairoPDF(paste(output_dir,'mrna_seq_diff_ratios.pdf',sep=''),width = 10,height = 20)
